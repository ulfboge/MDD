...
| `estimated_qc_sample.csv` | Manual QC export (50-row sample; auto-suggested decisions) |
| `estimated_qc_sample_reviewed.csv` | QC sample after human review (`qc_reviewed`, `qc_review_notes`) |
| `estimated_qc_sample_batch2.csv` | Second QC export (50 rows, post country-validation re-geocode) |
| `estimated_qc_sample_batch2_reviewed.csv` | Batch 2 after human review |
| `estimated_qc_sample_batch2_summary.csv` | Batch 2 decision counts |
...
| `estimated_qc_sample_batch4_reviewed.csv` | Batch 4 after human review |
| `estimated_qc_sample_batch4_summary.csv` | Batch 4 decision counts (49 accept, 1 reject) |
| `estimated_qc_sample_batch5.csv` | Fifth QC export (50 unreviewed proposed, medium confidence) |
| `estimated_qc_sample_batch5_reviewed.csv` | Batch 5 after human review |
| `estimated_qc_sample_batch5_summary.csv` | Batch 5 decision counts (50 accept) |
| `estimated_qc_sample_batch6.csv` | Sixth QC export (50 unreviewed proposed, medium confidence) |
| `estimated_qc_sample_batch6_reviewed.csv` | Batch 6 after human review |
| `estimated_qc_sample_batch6_summary.csv` | Batch 6 decision counts (49 accept, 1 reject) |
| `estimated_qc_sample_batch7.csv` | Seventh QC export (50 unreviewed proposed, medium confidence) |
| `estimated_qc_sample_batch7_reviewed.csv` | Batch 7 after human review |
| `estimated_qc_sample_batch7_summary.csv` | Batch 7 decision counts (50 accept) |
| `estimated_qc_sample_batch_remaining.csv` | **Final bulk export** — all 691 unreviewed proposed rows |
| `estimated_qc_sample_batch_remaining_suggest.csv` | Auto-suggest counts for bulk export (414 accept, 277 review) |
| `estimated_qc_sample_batch_remaining_reviewed.csv` | Bulk batch after human review |
| `estimated_qc_sample_batch_remaining_summary.csv` | Bulk decision counts (683 accept, 7 reject, 1 review) |
...
Auto-suggest decisions (country-hint validation):
...
Apply reviewed decisions back to the main CSV:
